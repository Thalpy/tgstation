...
/client/proc/generate_wikichem_reactions()
    set name = "Generate Wikireactions"
    set category = "Debug"
    set desc = "Generate a log output of ALL reactions for use with the wiki. This is the slow version that follows the structure of the wiki in it's output."
...
|-
"}
    //Big lists of chems, ala the wiki order

    for(var/_react in cached_reactions)
        var/datum/chemical_reaction/reaction = _react
